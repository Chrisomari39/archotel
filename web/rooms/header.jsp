        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm stciky-top">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mr-2" href="#Rooms">Rooms</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mr-2" href="#">Facilities</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mr-2" href="#Contact">Contact Us</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="form-inline my-2 my-lg-0">
                   ...
                   <a class="btn btn-outline-success shadow-none mr-4" href="login.jsp" role="button">Register</a>
                </div>
            </div>
        </nav>
